...
def conversation():
    ...
    try:
        ...
        try:
            ...
            text_splitter = RecursiveCharacterTextSplitter(chunk_size=375, chunk_overlap=50)
            ...
            for chunk in chunks:
                ...
                template+="{\"案卷\":\""+texts+"\",\"待审核\":\""+chunk.page_content+"\",\"审核结果\":\"______\"},\"风险等级\":\"\"},"
        ...
        question=template+"  这是一篇合同的数据，“content”是分片后得到的合同内容，结合“record”(劳动法的内容片段)推断“advice”和“level”；注>意：最后返回的是一个\
            JSON数组，每个JSON需要包含“content”、“advice”和“level”这3个字段以及对应的值其中“content”字段的值可以从直接返回。“advice”根据“record”结合“content”提\
                出你的建议，“level”的值根据潜在的风险评估填写高、中、低3个值。不用返回“record”->"
